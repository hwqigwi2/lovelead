...
const questions: Array<{ key: keyof QualificationInput; title: string; type: "age" | "boolean" }> = [
  { key: "age", title: "Сколько тебе лет?", type: "age" }, { key: "has_tbank", title: "Есть/была ли у тебя карта Т-Банк?", type: "boolean" }, { key: "is_military", title: "Являешься или был военнослужащим?", type: "boolean" }, { key: "has_arrest", title: "Есть ли у тебя аресты или ограничения по банковским счетам?", type: "boolean" },
];
